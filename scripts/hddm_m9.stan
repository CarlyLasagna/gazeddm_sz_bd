...
// absent) and other conditions (head orientation (forward, deviated).

//other other conditions are coded as follows: 1=forward head, 2=deviated head

////note this model is programmed the same as model 5, but the inputs (N_cond_other and cond_other variables)
