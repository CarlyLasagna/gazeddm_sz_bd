%model 7 - alpha also varies by emo
...
\resizebox{1\textwidth}{!}{
    \begin{tikzpicture}
        ...
        %beta
        \node[latent, left=of tau_i, xshift= -1.5cm] (beta_i) {$\beta_{i}$};
        \node[latent, above=of beta_i, xshift= -0.6cm,yshift=2cm] (beta_mu) {$\beta_{\mu_{h}}$};
        ...
        %alpha
        \node[latent, left=of beta_i, xshift= -1.9cm] (alpha_i) {$\alpha_{fi}$};
        ...
        %wiener distribution
        \factor[above=of RT, xshift= 2cm, yshift= 0.5cm] {C_2} {right:$\mathcal{W}(\alpha_i, 1-\beta_{fi}, -\delta_{fgi}, \tau_i)$} {} {RT}; 
        \factor[above=of RT, xshift= -1.5cm, yshift= 0.5cm] {C_1} {left:$\mathcal{W}(\alpha_i, \beta_{fi}, \delta_{fgi}, \tau_i)$} {} {RT};
